...
for year  , oscar_winners  in winners.items():
...
most_win_director = []
# # Add your code here
# heights_winner = max(win_count_dict.values())
# for  most_winner_name ,most_wins  in win_count_dict.items() :
#     if most_wins == heights_winner:
#         winner_is = "{} and wins {} Oscars".format(most_winner_name , most_wins)
#         most_win_director.append(winner_is)
     
# we can use also list comperehension and short it like this 
heights_winner = max(win_count_dict.values())
most_win_director = [most_winner_name for  most_winner_name ,most_wins in win_count_dict.items() if most_wins == heights_winner  ]


print("most_win_director = {}".format(most_win_director))

print('quiz 2 ends ' + ("=" * 30))